...
//User Username check on registration
Route::post('user-registration-check-username', 'Auth\RegisterController@checkUserRegistrationUsername');
//Check referral on registration
Route::post('user-registration-check-referral', 'Auth\RegisterController@checkUserRegistrationReferrral');
...
Route::group(['middleware' => ['guest:users', 'locale', 'twoFa', 'check-user-inactive'], 'namespace' => 'Users'], function () {
    ...
    //dailycheckin
    Route::post('dailycheckin', 'CustomerController@dailycheckin');
    ...
    Route::group(['middleware' => ['permission:manage_deposit', 'check-user-suspended']], function () {
        ...
        //Fun Cashback 100%
        Route::post('/cashback', 'FuncashbackController@cek');
        Route::post('/getcashback', 'FuncashbackController@get');
    ...
    Route::group(['middleware' => ['permission:manage_transaction']], function () {
        ...
        Route::get('history/referral', 'UserTransactionController@referral');
        Route::get('history/point', 'UserTransactionController@point');
