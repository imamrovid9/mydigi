...
class SettingController extends Controller
{
    ...
    public function general(Request $request)
    {
        ...
        if (!$_POST) {
            ...
            $rules = array(
                'name' => 'required',
                'xpoint' => 'required|numeric',
                'pricepoint' => 'required|numeric',
            );

            $fieldNames = array(
                'name' => 'Name',
                'xpoint' => 'Default X Point Referral',
            ...
            if ($validator->fails()) {
                ...
                Setting::where(['name' => 'xpoint'])->update(['value' => $request->xpoint]);
                Setting::where(['name' => 'pricepoint'])->update(['value' => $request->pricepoint]);
