    ...
    <div class="container">
        <div class="menu-list"> 
            <ul>
                ...
                @if(Common::has_permission(auth()->id(),'manage_transaction'))
                    <li class="<?= isset($menu) && ($menu == 'referral') ? 'active' : '' ?>"><a href="{{url('/history/referral')}}"><i class="fa fa-list"></i>History Referral</a></li>
                @endif

                @if(Common::has_permission(auth()->id(),'manage_transaction'))
                <li class="<?= isset($menu) && ($menu == 'point') ? 'active' : '' ?>"><a href="{{url('/history/point')}}"><i class="fa fa-list"></i>History Point</a></li>
                @endif
