                ...
                <div class="col-md-12 col-xs-12 col-sm-12 mb20 marginTopPlus">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="float-left trans-inline">Transaction Referral</h4>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table recent_activity" text-align="left">
                                    ...
                                    @if($transactionreferral->count()>0)
                                        @foreach($transactionreferral as $key=>$asd)
                                            <tr>
                                                <td></td>
                        ...
                        {{-- <div class="card-footer">
                            {{ $transactionreferral->appends($_GET)->links('vendor.pagination.bootstrap-4') }}
                        </div> --}}
                    </div>
                </div>
