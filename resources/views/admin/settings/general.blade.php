        ...
        <div class="box box-info">
            ...
            <form action="{{ url('admin/settings') }}" method="post" class="form-horizontal" enctype="multipart/form-data" id="general_settings_form">
                ...
                <!-- box-body -->
                  ...
                  {{-- xpoint --}}
        					<div class="form-group">
        					  <label class="col-sm-4 control-label" for="inputEmail3">Default X Point Referral</label>
        					  <div class="col-sm-6">
        					    <input type="number" name="xpoint" class="form-control" value="{{ @$result['xpoint'] }}" placeholder="10">
        					  	<span class="text-danger">{{ $errors->first('xpoint') }}</span>
        					  </div>
                  </div>
                  
                  {{-- harga point  --}}
        					<div class="form-group">
        					  <label class="col-sm-4 control-label" for="inputEmail3">Price Point</label>
        					  <div class="col-sm-6">
        					    <input type="number" name="pricepoint" class="form-control" value="{{ @$result['pricepoint'] }}" placeholder="10">
        					  	<span class="text-danger">{{ $errors->first('pricepoint') }}</span>
        					  </div>
        					</div>
