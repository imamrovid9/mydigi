                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control select2" name="type" id="type">
                                    ...
                                    <option value="{{ $ttype->transaction_type->id }}" {{ ($ttype->transaction_type->id == $type) ? 'selected' : '' }}>
                                        {{ ($ttype->transaction_type->name == "Withdrawal") ? "Payout" : ($ttype->transaction_type->name == "Exchange_To") ? "Fun Cashback" :str_replace('_', ' ', $ttype->transaction_type->name) }}
                                        {{-- {{ ($ttype->transaction_type->name == "Exchange_To") ? "Fun Cashback" : str_replace('_', ' ', $ttype->transaction_type->name) }} --}}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
