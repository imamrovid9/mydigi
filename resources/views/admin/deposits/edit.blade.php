									...
									<div class="col-md-5">
										<div class="panel panel-default">
											<div class="panel-body">
												...
												@if ($deposit->depositfirst == "yes")
													<div class="form-group total-deposit-space">
														<label class="control-label col-sm-6" for="total">First Time Deposit</label>
														<input type="hidden" class="form-control" name="firsttimedposit" value="yes">
														<div class="col-sm-6">
